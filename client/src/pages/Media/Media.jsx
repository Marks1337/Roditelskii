        ...
        <div className={styles.containerPhoto}>
          ...
          <div className={styles.boxImg}>
            <div className={styles.photo1}>
              <img src="./img/mediaPhoto1.png" alt="" />
            </div>
            <div className={styles.photo2}>
              <img src="./img/mediaPhoto2.png" alt="" />
            </div>
            <div className={styles.photo3}>
              <img src="./img/mediaPhoto3.png" alt="" />
            </div>
            <div className={styles.photo4}>
              <img src="./img/mediaPhoto4.png" alt="" />
            </div>
            <div className={styles.photo5}>
              <img src="./img/mediaPhoto5.png" alt="" />
            </div>
            <div className={styles.photo6}>
              <img src="./img/mediaPhoto6.png" alt="" />
            </div>
          </div>
        </div>
      </div>
          ...
          <div className={styles.boxVideo}>
            <div className={styles.video4}>
              <iframe
                width="680"
                height="380"
                src="https://www.youtube.com/embed/Ng7ZQhhxN64?si=zJFdzUQV3wUParjU"
            ...
            <div className={styles.video4}>
              <iframe
                width="680"
                height="380"
                src="https://www.youtube.com/embed/q9hF26Ci434?si=i_I8puJNYDpNi0Hn"
                title="YouTube video player"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                referrerpolicy="strict-origin-when-cross-origin"
            ...
            <div className={styles.video4}>
              <iframe
                width="680"
                height="380"
                src="https://www.youtube.com/embed/Y6lsjw2Aewg?si=JMZvLgUbyDH42MYs"
                title="YouTube video player"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                referrerpolicy="strict-origin-when-cross-origin"
            ...
            <div className={styles.video4}>
              <iframe
                width="680"
                height="380"
                src="https://www.youtube.com/embed/cI8vyVOXzr8?si=MpCB9tTj0zLQBIWo"
                title="YouTube video player"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                referrerpolicy="strict-origin-when-cross-origin"
